...
describe '[STEP1] ユーザログイン前のテスト' do
  ...
  describe 'ヘッダーのテスト: ログインしていない場合' do
    ...
    context '表示内容の確認' do
      it 'レシぺ一覧リンクが表示される: 左上から1番目のリンクが「レシピ一覧」である' do
        recipes_link = find_all('a')[1].native.inner_text
        expect(recipes_link).to match(/recipes/i)
      end
      it 'レシピグラマー一覧リンクが表示される: 左上から2番目のリンクが「レシピグラマー一覧」である' do
      ...
      it '新規登録リンクが表示される: 左上から4番目のリンクが「新規登録」である' do
        signin_link = find_all('a')[4].native.inner_text
        expect(signin_link).to match(/sign up/i)
      end
    end
  ...
  describe 'ヘッダーのテスト: ログインしている場合' do
    ...
    context 'ヘッダーの表示を確認' do
      ...
      it 'レシピ一覧リンクが表示される: 左上から1番目のリンクが「レシピ一覧」である' do
        recipes_link = find_all('a')[1].native.inner_text
        expect(recipes_link).to match(/recipes/i)
      end
      it 'レシピグラマー一覧リンクが表示される: 左上から2番目のリンクが「レシピグラマー一覧」である' do
